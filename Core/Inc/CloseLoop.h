...
// Settings for AX5689 Design 4 x MP1916, 8 x GaNFET
// Audio input format: I2S 2 channels 192 kHz sample rate 
// 2 x BTL, output filter: 4x L = 4.7 uH, 4x C = 1.0 uF, 2x C = 0.47 uF
// ADC input resistors: 10000 Ohm (0.1 %)
// PVDD = 50
// Date: 2025/04/09 14:13:18

const uint16_t amplifierCommands_CloseLoop[] = {
...
0x0053, 0xFFFC, // ChannelAloopfilterfeedin3PCMcoefficientstage7
...
0x0057, 0x0995, // ChannelAloopfilterstage1FBcoefficientstage1
0x0058, 0x0203, // ChannelAloopfilterstage1MACcontrolstage1
0x0059, 0x0A71, // ChannelAloopfilterstage2FFcoefficientstage2
0x005A, 0x0455, // ChannelAloopfilterstage2FBcoefficientstage2
0x005B, 0x0203, // ChannelAloopfilterstage2MACcontrolstage2
0x005C, 0x0BE3, // ChannelAloopfilterstage3FFcoefficientstage3
0x005D, 0x0BC3, // ChannelAloopfilterstage3FBcoefficientstage3
...
0x0066, 0x0508, // ChannelAloopfilterstage6FBcoefficientstage6
0x0067, 0x0201, // ChannelAloopfilterstage6MACcontrolstage6
0x0068, 0x0BF6, // ChannelAloopfilterstage7FFcoefficientstage7
...
0x00D6, 0x0B83, // ChannelCloopfilterstage1FFcoefficientstage1
0x00D7, 0x0001, // ChannelCloopfilterstage1FBcoefficientstage1
0x00D8, 0x0213, // ChannelCloopfilterstage1MACcontrolstage1
0x00D9, 0x06B7, // ChannelCloopfilterstage2FFcoefficientstage2
0x00DA, 0x08AB, // ChannelCloopfilterstage2FBcoefficientstage2
0x00DB, 0x0217, // ChannelCloopfilterstage2MACcontrolstage2
0x00DC, 0x06E7, // ChannelCloopfilterstage3FFcoefficientstage3
0x00DD, 0x0FDC, // ChannelCloopfilterstage3FBcoefficientstage3
0x00DE, 0x0217, // ChannelCloopfilterstage3MACcontrolstage3
0x00DF, 0x05E7, // ChannelCloopfilterstage4FFcoefficientstage4
0x00E0, 0x04A5, // ChannelCloopfilterstage4FBcoefficientstage4
0x00E1, 0x0217, // ChannelCloopfilterstage4MACcontrolstage4
0x00E2, 0x0BC7, // ChannelCloopfilterstage5FFcoefficientstage5
0x00E3, 0x09A6, // ChannelCloopfilterstage5FBcoefficientstage5
0x00E4, 0x0219, // ChannelCloopfilterstage5MACcontrolstage5
0x00E5, 0x0A56, // ChannelCloopfilterstage6FFcoefficientstage6
0x00E6, 0x04A6, // ChannelCloopfilterstage6FBcoefficientstage6
0x00E7, 0x0215, // ChannelCloopfilterstage6MACcontrolstage6
0x00E8, 0x08DA, // ChannelCloopfilterstage7FFcoefficientstage7
0x00E9, 0x0F8C, // ChannelCloopfilterstage7FBcoefficientstage7
0x00EA, 0x0217, // ChannelCloopfilterstage7MACcontrolstage7
0x0000, 0x0000, // Programmingmode
0x0000, 0x0088, // Programmingmode
0x010D, 0xC14A, // ChannelDloopfilterfeedin3PCMcoefficientstage1
0x010E, 0xC57C, // ChannelDloopfilterfeedin3PCMcoefficientstage2
0x010F, 0x2977, // ChannelDloopfilterfeedin3PCMcoefficientstage3
0x0110, 0x00DF, // ChannelDloopfilterfeedin3PCMcoefficientstage4
...
0x0119, 0x07B7, // ChannelDloopfilterstage2FFcoefficientstage2
0x011A, 0x0656, // ChannelDloopfilterstage2FBcoefficientstage2
0x011B, 0x0211, // ChannelDloopfilterstage2MACcontrolstage2
0x011C, 0x0B38, // ChannelDloopfilterstage3FFcoefficientstage3
0x011D, 0x0B08, // ChannelDloopfilterstage3FBcoefficientstage3
0x011E, 0x0211, // ChannelDloopfilterstage3MACcontrolstage3
0x011F, 0x04B7, // ChannelDloopfilterstage4FFcoefficientstage4
...
0x0125, 0x0928, // ChannelDloopfilterstage6FFcoefficientstage6
0x0126, 0x0A19, // ChannelDloopfilterstage6FBcoefficientstage6
0x0127, 0x0211, // ChannelDloopfilterstage6MACcontrolstage6
0x0128, 0x0505, // ChannelDloopfilterstage7FFcoefficientstage7
...
0x006C, 0x3EF1, // ChannelAPWMPWMcarrierinitfall
0x006D, 0x3E6D, // ChannelAPWMPWMcarrierthrise
0x006E, 0x0089, // ChannelAPWMPWMcarrierthfall
0x006F, 0x0210, // ChannelAPWMPWMstepsizeinitrise
0x0070, 0xFDDE, // ChannelAPWMPWMstepsizeinitfall
0x0071, 0x0000, // ChannelAPWMPWMstepsizedeltarise
0x0072, 0x0000, // ChannelAPWMPWMstepsizedeltafall
0x0073, 0x3EF1, // ChannelAPWMPWMstartcarrier
0x0074, 0xFDDE, // ChannelAPWMPWMstartstepsize
0x0075, 0x001A, // ChannelAPWMPWMcontrol
0x0000, 0x0000, // Programmingmode
0x0000, 0x0044, // Programmingmode
0x00EB, 0x0000, // ChannelCPWMPWMcarrierinitrise
0x00EC, 0x3EF1, // ChannelCPWMPWMcarrierinitfall
0x00ED, 0x3E6D, // ChannelCPWMPWMcarrierthrise
0x00EE, 0x0089, // ChannelCPWMPWMcarrierthfall
0x00EF, 0x0210, // ChannelCPWMPWMstepsizeinitrise
0x00F0, 0xFDDE, // ChannelCPWMPWMstepsizeinitfall
0x00F1, 0x0000, // ChannelCPWMPWMstepsizedeltarise
0x00F2, 0x0000, // ChannelCPWMPWMstepsizedeltafall
0x00F3, 0x3EF1, // ChannelCPWMPWMstartcarrier
0x00F4, 0xFDDE, // ChannelCPWMPWMstartstepsize
0x00F5, 0x001A, // ChannelCPWMPWMcontrol
0x0000, 0x0000, // Programmingmode
0x0000, 0x0022, // Programmingmode
0x00AB, 0x0000, // ChannelBPWMPWMcarrierinitrise
0x00AC, 0x3EF1, // ChannelBPWMPWMcarrierinitfall
0x00AD, 0x3E6D, // ChannelBPWMPWMcarrierthrise
0x00AE, 0x0089, // ChannelBPWMPWMcarrierthfall
0x00AF, 0x0210, // ChannelBPWMPWMstepsizeinitrise
0x00B0, 0xFDDE, // ChannelBPWMPWMstepsizeinitfall
0x00B1, 0x0000, // ChannelBPWMPWMstepsizedeltarise
0x00B2, 0x0000, // ChannelBPWMPWMstepsizedeltafall
0x00B3, 0x3EF1, // ChannelBPWMPWMstartcarrier
0x00B4, 0xFDDE, // ChannelBPWMPWMstartstepsize
0x00B5, 0x001E, // ChannelBPWMPWMcontrol
0x0000, 0x0000, // Programmingmode
0x0000, 0x0088, // Programmingmode
0x012B, 0x0000, // ChannelDPWMPWMcarrierinitrise
0x012C, 0x3EF1, // ChannelDPWMPWMcarrierinitfall
0x012D, 0x3E6D, // ChannelDPWMPWMcarrierthrise
0x012E, 0x0089, // ChannelDPWMPWMcarrierthfall
0x012F, 0x0210, // ChannelDPWMPWMstepsizeinitrise
0x0130, 0xFDDE, // ChannelDPWMPWMstepsizeinitfall
0x0131, 0x0000, // ChannelDPWMPWMstepsizedeltarise
0x0132, 0x0000, // ChannelDPWMPWMstepsizedeltafall
0x0133, 0x3EF1, // ChannelDPWMPWMstartcarrier
0x0134, 0xFDDE, // ChannelDPWMPWMstartstepsize
...
0x0000, 0x0000, // Programmingmode
0x0021, 0x0F40, // ChargePumpControl
0x0022, 0x024B, // ChargePumpGain
0x0023, 0x0000, // ChargePumpCMweight
0x0024, 0x007E, // ChargePumpDMweight
0x0025, 0x0001, // ReferenceGeneratorControl
0x0026, 0x3F13, // ReferenceGeneratorAnalog1
0x0027, 0x0000, // ReferenceGeneratorAnalog2
0x0028, 0x47D7, // ReferenceADCenables
...
0x002D, 0x181A, // ReferenceADCanalog1
0x002E, 0x000F, // ReferenceADCanalog2
...
float PVDD_CloseLoop = 50;
uint32_t SAMPLE_RATE_CloseLoop = 192000;
float UVP_CloseLoop = 45;
float OVP_CloseLoop = 55;
uint16_t VolumeHex_CloseLoop = 0x8FF6;